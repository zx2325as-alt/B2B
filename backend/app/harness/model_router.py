...
class ModelRouter:
    ...
    TASK_MAP: dict[str, TaskComplexity] = {
        ...
        "perspective_debate": TaskComplexity.COMPLEX,
        ...
        "theory_of_mind": TaskComplexity.COMPLEX,
        "counterfactual_predict": TaskComplexity.COMPLEX,
        "prediction_review": TaskComplexity.MEDIUM,
        "goal_progress_review": TaskComplexity.MEDIUM,
        "quick_profile_infer": TaskComplexity.MEDIUM,
...
class OutputGuardrails:
    ...
    REQUIRED_FIELDS: dict[str, list[str]] = {
        ...
        "theory_of_mind": ["knows", "unaware", "hiding"],
        "counterfactual_predict": ["predicted_reply", "reaction_type"],
        "prediction_review": ["verdict"],
        "goal_progress_review": ["current_score"],
        "quick_profile_infer": ["facts"],
